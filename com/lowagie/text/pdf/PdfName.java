    ...
    public static String decodeName(String string) {
        ...
        try {
            ...
            for (int i = 1; i < n; ++i) {
                ...
                if (c == '#') {
                    c = (char)((PRTokeniser.getHex(string.charAt(i + 1)) << 4) + PRTokeniser.getHex(string.charAt(i + 2)));
                    i += 2;
                }
